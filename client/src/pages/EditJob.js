...
export default function EditJob({notification}){
    ...
    const onSubmit = (data) => {
        ...
        const obj = {...data, recruiterId: rid, companyEmail: remail}
        axios.patch(`http://localhost:5000/api/job/${id}`, obj).then((response) => {
            console.log("response : ", response);
            if(response?.status == 200){
                // alert("Job Updated Successfully.");
                handleAlert();
                reset({jobName: "", city: "", desiredJob: "", qualificationsReq: "", jobType: "", jobDescription: "", minSalary: "", maxSalary: ""});
            }
        }).catch((err) => {
    ...
    return (
        <>
            ...
            <Navbar type={1} notification={notification} />
            <div className='w-100'>
                {/* <form onSubmit={handleSubmit(onSubmit)}> */}
                    <Container>
                        <Row>
                            <Col md={1}></Col>
                            <Col md={10}>
                                <h1 className='text-center mt-4'>Edit a Job</h1>
                                    ...
                                    <Row>
                                        <Col md={6} className="px-4">
                                            ...
                                            {/* <Form.Group className="mb-3" controlId="formBasicPassword1">
                                                ...
                                                <Form.Control type="text" {...register("salary", {required: true})} placeholder="Enter Salary detail" />
                                            ...
                                            <Row>
                                                <Col md={6}>
                                                    <Form.Group className="mb-3" controlId="formBasicPassword1">
                                                        ...
                                                        <Form.Control type="text" {...register("minSalary", {required: true})} placeholder="Enter Min Salary detail" />
                                                ...
                                                <Col md={6}>
                                                    <Form.Group className="mb-3" controlId="formBasicPassword1">
                                                        ...
                                                        <Form.Control type="text" {...register("maxSalary", {required: true})} placeholder="Enter Max Salary detail" />
