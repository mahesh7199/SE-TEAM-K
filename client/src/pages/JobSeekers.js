...
export default function JobSeekers({notification}){
    ...
    return (
        <>
            ...
            <Navbar type={1} tab={7} notification={notification} />
            <div className='w-100 mt-5'>
                <Container>
                    <div className="w-100 d-flex">
                        <div className="w-50 py-4 mb-md-5 mb-0">
                            <h2 className="text-start">Job Seekers are waiting for you</h2>
                        </div>
                                ...
                                job && (
                                    <>
                                        <tr>
                                            ...
                                            <td>{job?.city}</td>
                                            <td>{job?.country}</td>
                                            <td className='text-center'><button className='btn btn-primary' onClick={() => navigate(`/profile/${job?._id}`)}>View</button></td>
